  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'x64') {
      if (process.config?.variables?.shlib_suffix === 'dll.a' || process.config?.variables?.node_target_type === 'shared_library') {
        try {
        return require('./awrit-native-rs.win32-x64-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        const binding = require('awrit-native-rs-win32-x64-gnu')
        const bindingPackageVersion = require('awrit-native-rs-win32-x64-gnu/package.json').version
        if (bindingPackageVersion !== '2.0.3' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 2.0.3 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
    ...
    if (process.arch === 'x64') {
      ...
      if (isMusl()) {
        try {
          return require('./awrit-native-rs.linux-loong64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
          const binding = require('awrit-native-rs-linux-loong64-musl')
          const bindingPackageVersion = require('awrit-native-rs-linux-loong64-musl/package.json').version
          if (bindingPackageVersion !== '2.0.3' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
            throw new Error(`Native binding package version mismatch, expected 2.0.3 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
          return binding
        ...
        try {
          return require('./awrit-native-rs.linux-loong64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
          const binding = require('awrit-native-rs-linux-loong64-gnu')
          const bindingPackageVersion = require('awrit-native-rs-linux-loong64-gnu/package.json').version
          if (bindingPackageVersion !== '2.0.3' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
            throw new Error(`Native binding package version mismatch, expected 2.0.3 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
          return binding
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
  ...
  try {
    wasiBinding = require('./awrit-native-rs.wasi.cjs')
  ...
  if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
    try {
      wasiBinding = require('awrit-native-rs-wasm32-wasi')
      nativeBinding = wasiBinding
    } catch (err) {
      if (process.env.NAPI_RS_FORCE_WASI) {
        if (!wasiBindingError) {
