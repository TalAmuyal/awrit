...
const eventTypes = props.eventType.type.split('|').map(t => t.trim().replace(/['"]/g, ''));
const unionTypes = [];
...
// Replace in the file
const newContent = content.replace(interfaceRegex, unionType);

fs.writeFileSync(indexPath, newContent);
console.log('Successfully converted TermEvent interface to union type'); 